...
public class AdvancedStatsWindow extends JDialog {
    ...
    public AdvancedStatsWindow(JFrame parent) {
        super(parent, "Statistiche Avanzate", true);
    ...
    private void initComponents() {
        ...
        periodCombo = new JComboBox<>(new String[]{"Ultimi 6 mesi", "Ultimo anno", "Ultimi 2 anni"});
        ...
        String[] columns = {"Prodotto", "Quantità Venduta", "Fatturato", "% sul Totale"};
        ...
        // Aggiunta tabs
        tabbedPane.addTab("Andamento Vendite", salesPanel);
        tabbedPane.addTab("Analisi Prodotti", productsPanel);
    ...
    private void loadSalesData() {
        try {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                pstmt.setString(1, new SimpleDateFormat("yyyy-MM-dd").format(cal.getTime()));
            ...
            JOptionPane.showMessageDialog(this,
                "Errore durante il caricamento dei dati di vendita: " + e.getMessage(),
        ...
        try {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                ...
                topProductsTable.setModel(new javax.swing.table.DefaultTableModel(
                    data,
                    new String[]{"Prodotto", "Quantità Venduta", "Fatturato", "% sul Totale"}
                ));
            }
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this,
                "Errore durante il caricamento dei dati dei prodotti: " + e.getMessage(),
                "Errore", JOptionPane.ERROR_MESSAGE);
        }
    }
