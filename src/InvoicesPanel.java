...
public class InvoicesPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        // FIXED: Stile migliorato per il pulsante PDF - rimuovi colore di sfondo problematico
        generatePDFButton.setFont(generatePDFButton.getFont().deriveFont(Font.BOLD));
        generatePDFButton.setPreferredSize(new Dimension(120, 30));
        // Usa colori del sistema invece di colori custom
        ...
        if (selectedRow != -1) {
            try {
                ...
                if (invoice != null && customer != null) {
                    ...
                    if (parentWindow instanceof JFrame) {
                        progressDialog = new JDialog((JFrame) parentWindow, "Generating PDF", true);
                    } else if (parentWindow instanceof JDialog) {
                        progressDialog = new JDialog((JDialog) parentWindow, "Generating PDF", true);
                    } else {
                        progressDialog = new JDialog((JFrame) null, "Generating PDF", true);
                    }
                    JLabel progressLabel = new JLabel("Generating PDF, please wait...", SwingConstants.CENTER);
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected void done() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                JOptionPane.showMessageDialog(InvoicesPanel.this,
