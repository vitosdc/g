...
public class WarehouseReportWindow extends JDialog {
    ...
    private void loadProductsData() {
        ...
        try {
            ...
            ((JLabel)components[0]).setText("Total Products: " + totalProducts);
            ((JLabel)components[1]).setText(String.format("Total Value: € %.2f", totalValue));
            ((JLabel)components[2]).setText("Low Stock Products: " + lowStock);
            ((JLabel)components[3]).setText("Out of Stock Products: " + outOfStock);
