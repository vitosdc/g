...
public class WarehouseWindow extends JDialog {
        ...
        try {
            ...
            try (Statement stmt = conn.createStatement();
                ...
                while (rs.next()) {
                    ...
                    // FIXED: Use DateUtils for proper date parsing - explicitly use java.util.Date
                    java.util.Date movementDate = DateUtils.parseDate(rs, "data");
        ...
        try {
            ...
            try (Statement stmt = conn.createStatement();
                ...
                while (rs.next()) {
                    ...
                    // FIXED: Use DateUtils for proper date parsing - explicitly use java.util.Date
                    java.util.Date notificationDate = DateUtils.parseDate(rs, "data");
            ...
            try {
                ...
                try (PreparedStatement pstmt = conn.prepareStatement(updateQuery)) {
                    for (int row : selectedRows) {
                        ...
                        // FIXED: Better way to find notification ID
    ...
    class MinimumStockDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            gbc.gridx = 1;
            gbc.weightx = 1.0; // Expand the text field
            JTextField productField = new JTextField(minStock.getProdottoNome());
            productField.setEditable(false);
            productField.setPreferredSize(new Dimension(300, 25));
            ...
            minQuantitySpinner.setPreferredSize(new Dimension(300, 25));
            ...
            reorderQuantitySpinner.setPreferredSize(new Dimension(300, 25));
            ...
            leadTimeSpinner.setPreferredSize(new Dimension(300, 25));
            ...
            supplierCombo.setPreferredSize(new Dimension(300, 25));
            loadSuppliers();
            ...
            gbc.gridx = 1;
            gbc.weightx = 1.0;
            gbc.weighty = 1.0; // Add vertical weight
            ...
            notesScroll.setPreferredSize(new Dimension(300, 50));
            notesScroll.setMinimumSize(new Dimension(300, 50));
        ...
        private void saveMinStock() {
            try {
                ...
                // FIXED: Check if a configuration already exists using prodotto_id (not id)
